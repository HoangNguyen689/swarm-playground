...
@pytest.mark.parametrize(
    "query,function_name",
    [
        ("I want to write an email!", "transfer_to_email"),
        ("I want to schedule an appointment!", "transfer_to_schedule"),
    ],
)
def test_operator_agent_calls_correct_function(query, function_name):
    tool_calls = run_and_get_tool_calls(operator_agent, query)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            ...
            {"role": "user", "content": "I want to write an email."},
            {"role": "tool", "tool_name": "transfer_to_email"},
